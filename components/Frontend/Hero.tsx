...
const Hero = () => {
    ...
    return (
        <div className="bg-white text-gray-200 h-screen">
                        ...
                        <div className="flex flex-col justify-center">
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-6">
                                <div className="flex items-center justify-center md:justify-start">
                                    <span className="text-slate-600 mr-2">Find</span>
                                    <TransitionalText 
                                        className="text-blue-500 mx-2" 
                                        TEXTS={TEXTS} 
                                    />
                                </div>
                                <span className="block text-slate-700 mt-2">across the UK</span>
                            </h1>
                            ...
                            <div className="flex justify-center md:justify-start space-x-6 mb-8">
                                <div className="flex flex-col items-center">
                                    <HeartPulse className="text-blue-500 w-10 h-10 mb-2" />
                                ...
                                <div className="flex flex-col items-center">
                                    <StethoscopeIcon className="text-blue-500 w-10 h-10 mb-2" />
