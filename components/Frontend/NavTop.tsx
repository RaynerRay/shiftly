      ...
      <div className="flex h-12 py-2 px-4 items-center justify-between max-w-7xl mx-auto">
        ...
        <div className=" items-center space-x-4 px-4 hidden lg:block ">
          ...
          <div className="inline-flex items-center text-gray-500 hover:text-sky-500" >
            ...
            <span className=" ml-2 text-sm font-bold text-sky-500">+263-772-340-505</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link className="inline-flex items-center text-gray-500 hover:text-sky-500" href="/services">
            <HomeIcon className="w-3 h-3" />
            <span className=" ml-2 text-sm font-bold text-sky-500">Home Services</span>
          </Link>
          <Link className="inline-flex items-center text-gray-500 hover:text-sky-500" href="/contact">
            <Phone className="w-3 h-3 " />
            <span className=" ml-2 text-sm font-bold text-sky-500">Contact</span>
          </Link>
        </div>
        </div>
      </div>
