...
//   return (
//     <div className="w-72 p-4 bg-white :bg-sky-800 rounded-lg border border-gray-200 :border-gray-600 shadow-md hover:border-gray-400 transition-all duration-300">
...
//           <span className="px-2 py-1 text-xs bg-gray-50 text-sky-800 :bg-yellow-700 :text-yellow-100 rounded-md">
...
//             <span className="px-2 py-1 text-xs bg-green-100 text-green-800 :bg-green-700 :text-green-100 rounded-sm">
//               Available today
//             </span>
//             <span className="px-2 py-1 text-xs bg-purple-50 text-purple-800 :bg-green-700 :text-green-100  rounded-sm">
//                {doctor.doctorProfile?.gender}
//             </span>
//           </div>
//         </div>

//         <p className="text-xs text-gray-800 :text-gray-300 mb-2 truncate">
...
//         <span className="text-sm text-sky-600 :text-blue-400 ml-2">
