...
export default function DoctorDetails({
  ...
  //   } else {
  //     // Check if the new time is consecutive with already selected times
  //     const timeInMinutes = convertTimeToMinutes(time);
  //     const isConsecutive = selectedTimes.length === 0 || 
  //       selectedTimes.some(t => {
  //         const existingTimeInMinutes = convertTimeToMinutes(t);
  //         return Math.abs(existingTimeInMinutes - timeInMinutes) === 60;
  //       });
